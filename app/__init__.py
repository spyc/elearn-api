...
class RequestHandler(object):
    ...
    def initialize(self):
        ...
        Example::
            class ProfileHandler(RequestHandler):
                def initialize(self, database.ini):
                    self.database.ini = database.ini
                def get(self, username):
                    ...
            app = Application([
                (r'/user/(.*)', ProfileHandler, dict(database.ini=database.ini)),
                ])
        """
        pass
    ...
    def locale(self):
        ...
        database.ini, or `get_browser_locale`, which uses the ``Accept-Language``
        header.
        .. versionchanged: 4.1
...
class StaticFileHandler(RequestHandler):
    ...
    **Subclassing notes**
    ...
    static content from a database.ini), override `get_content`,
